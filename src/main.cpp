...
const string strMessageMagic = "ucoincash Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
            ...
            int64_t nSubsidy = 5 * COIN; //Miner reward

            if(nBestHeight == 0)
            {
                //nSubsidy = 4819323 * COIN; //Total premine coin
                nSubsidy = 8900000 * COIN; //Total premine coin
            }
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    printf("Block Number %d \n",nBestHeight);
        ...
        if(nBestHeight < YEARLY_BLOCKCOUNT)
            nRewardCoinYear = 6.6 * COIN_YEAR_REWARD; //60% reward for 131400 blocks
    	else if(nBestHeight < (2 * YEARLY_BLOCKCOUNT))
            nRewardCoinYear = 4.8 * COIN_YEAR_REWARD; //50% reward for 131400 * 2 blocks
    	else if(nBestHeight < (3 * YEARLY_BLOCKCOUNT))
            nRewardCoinYear = 3.6 * COIN_YEAR_REWARD; //40% reward for 131400 * 3 blocks
            ...
            nRewardCoinYear = 0.9 * COIN_YEAR_REWARD; //20% reward for 131400 * 5 blocks
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ucoincash", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
